...
export const LEARN_STEPS = [
    ...
    {
        title: 'НЕ ПОВТОРЯЙСЯ',
        body: 'Противники сильнее первого яруса помнят твои последние ходы. Если одна стихия занимает больше половины истории, они закрывают часть слотов контр-стихией — позиции каждый раунд новые. Меняй узор.',
        build: () => {
            const box = el('div', 'demo-row');
            box.style.flexDirection = 'column';
            box.style.gap = '6px';
            ...
            box.append(spam, answer, el('span', 'demo-verdict', 'узор прочитан — первые слоты закрыты контр-стихией'));
            return box;
        },
    },
];
