...
const ROBES = {
    player: { light: '#43548b', dark: '#1e2748', trim: '#5a6db4', skin: '#e8c49c' },
    fire: { light: '#8a3f26', dark: '#3a1710', trim: '#c2643a', skin: '#dfb188' },
    water: { light: '#245a86', dark: '#0e2237', trim: '#3d8ec2', skin: '#d9c3b0' },
    wind: { light: '#4a7330', dark: '#1b2d13', trim: '#7fae4a', skin: '#e2c9a2' },
};
...
<svg viewBox="0 0 120 160" xmlns="http://www.w3.org/2000/svg" role="img">
  ...
  <path d="M58 10 C39 10 29 27 31 48 C36 58 80 58 85 48 C87 27 77 10 58 10 Z" fill="${palette.trim}"/>
  <path d="M58 10 C39 10 29 27 31 48 L38 50 C36 30 45 16 58 15 Z" fill="#fff" opacity=".12"/>
