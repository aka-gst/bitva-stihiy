...
export function coachLine(state, extra = {}) {
    ...
    if (combo) {
        ...
        return {
            ...
            text: `Первые три хода складываются в узор: ${combo.name}.`
                + ` Нужно выиграть ${combo.needs} обмена из 3 внутри него.`
    ...
    return {
        tone: 'combo',
        text: 'Первые три хода складываются в узор: чем больше в них повторов, тем сильнее удар.',
    };
}
